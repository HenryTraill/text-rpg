    ...
    if exit_code == 0:
        ...
        if coverage_file.exists():
            ...
            try:
                ...
                print("💡 Open htmlcov/index.html in your browser to view the coverage report")
...
Examples:
  ...
  python run_tests.py --file tests/unit/test_auth_utils.py  # Run specific file
    ...
    parser.add_argument(
        "--health", 
        action="store_true", 
        help="Run health check tests only"
    )
    parser.add_argument(
        "--fast", 
        action="store_true", 
    ...
    parser.add_argument(
        "--coverage", 
        action="store_true", 
        help="Run tests with HTML coverage report"
    )
    parser.add_argument(
        "--file", 
        type=str, 
        help="Run tests in specific file"
    )
    parser.add_argument(
        "--check-deps", 
        action="store_true", 
