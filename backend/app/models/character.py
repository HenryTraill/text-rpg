...
class Character(SQLModel, table=True):
    ...
    combat_participants: List["CombatParticipant"] = Relationship(back_populates="character")
    
    # Location history
    location_history: List["CharacterLocation"] = Relationship(back_populates="character")
