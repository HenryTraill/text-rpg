...
def upgrade() -> None:
    ...
    sa.Column('current_turn_character_id', sqlmodel.sql.sqltypes.GUID(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('item_type', sa.Enum('WEAPON', 'ARMOR', 'CONSUMABLE', 'MATERIAL', 'TOOL', 'QUEST', 'CURRENCY', name='itemtype'), nullable=False),
    ...
    sa.Column('equipment_slot', sa.Enum('MAIN_HAND', 'OFF_HAND', 'HEAD', 'CHEST', 'LEGS', 'FEET', 'GLOVES', 'RING_1', 'RING_2', 'NECK', 'BACK', name='equipmentslot'), nullable=True),
    ...
    sa.Column('crafting_skill_required', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('description', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('category', sa.Enum('COMBAT', 'GATHERING', 'CRAFTING', 'SOCIAL', name='skillcategory'), nullable=False),
    ...
    sa.Column('role', sa.Enum('PLAYER', 'MODERATOR', 'ADMIN', 'DEVELOPER', name='userrole'), nullable=False),
    ...
    op.create_index(op.f('ix_world_events_name'), 'world_events', ['name'], unique=False)
    ...
    op.create_index(op.f('ix_crafting_recipes_name'), 'crafting_recipes', ['name'], unique=False)
    ...
    op.create_table('zone_instances',
    sa.Column('id', sqlmodel.sql.sqltypes.GUID(), nullable=False),
    sa.Column('zone_id', sqlmodel.sql.sqltypes.GUID(), nullable=False),
    ...
    op.create_index(op.f('ix_zone_instances_zone_id'), 'zone_instances', ['zone_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['seller_id'], ['characters.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_channel_memberships_character_id'), 'channel_memberships', ['character_id'], unique=False)
    ...
    op.create_index(op.f('ix_character_locations_zone_id'), 'character_locations', ['zone_id'], unique=False)
    ...
    op.create_index(op.f('ix_combat_actions_character_id'), 'combat_actions', ['character_id'], unique=False)
    op.create_index(op.f('ix_combat_actions_combat_session_id'), 'combat_actions', ['combat_session_id'], unique=False)
    ...
    op.create_index(op.f('ix_combat_participants_combat_session_id'), 'combat_participants', ['combat_session_id'], unique=False)
    ...
    op.create_index(op.f('ix_combat_results_combat_session_id'), 'combat_results', ['combat_session_id'], unique=False)
    ...
    sa.Column('status', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['character_1_id'], ['characters.id'], ),
    sa.ForeignKeyConstraint(['character_2_id'], ['characters.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_friendships_character_1_id'), 'friendships', ['character_1_id'], unique=False)
    op.create_index(op.f('ix_friendships_character_2_id'), 'friendships', ['character_2_id'], unique=False)
    ...
    op.create_index(op.f('ix_guild_members_character_id'), 'guild_members', ['character_id'], unique=False)
    ...
    sa.Column('equipped_slot', sa.Enum('MAIN_HAND', 'OFF_HAND', 'HEAD', 'CHEST', 'LEGS', 'FEET', 'GLOVES', 'RING_1', 'RING_2', 'NECK', 'BACK', name='equipmentslot'), nullable=True),
    ...
    op.create_index(op.f('ix_inventory_slots_character_id'), 'inventory_slots', ['character_id'], unique=False)
    op.create_index(op.f('ix_inventory_slots_item_id'), 'inventory_slots', ['item_id'], unique=False)
    ...
    op.create_index(op.f('ix_npc_merchants_location_id'), 'npc_merchants', ['location_id'], unique=False)
    op.create_index(op.f('ix_npc_merchants_name'), 'npc_merchants', ['name'], unique=False)
    ...
    sa.ForeignKeyConstraint(['trader_1_id'], ['characters.id'], ),
    sa.ForeignKeyConstraint(['trader_2_id'], ['characters.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_trades_trader_1_id'), 'trades', ['trader_1_id'], unique=False)
    op.create_index(op.f('ix_trades_trader_2_id'), 'trades', ['trader_2_id'], unique=False)
    ...
    op.create_index(op.f('ix_message_history_message_id'), 'message_history', ['message_id'], unique=False)
    ...
    op.create_index(op.f('ix_party_members_character_id'), 'party_members', ['character_id'], unique=False)
    op.create_index(op.f('ix_party_members_party_id'), 'party_members', ['party_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_combat_results_combat_session_id'), table_name='combat_results')
    op.drop_table('combat_results')
    op.drop_index(op.f('ix_combat_participants_combat_session_id'), table_name='combat_participants')
    op.drop_index(op.f('ix_combat_participants_character_id'), table_name='combat_participants')
    op.drop_table('combat_participants')
    op.drop_index(op.f('ix_combat_actions_combat_session_id'), table_name='combat_actions')
    ...
    op.drop_index(op.f('ix_character_locations_zone_id'), table_name='character_locations')
    op.drop_index(op.f('ix_character_locations_character_id'), table_name='character_locations')
    op.drop_table('character_locations')
    op.drop_index(op.f('ix_channel_memberships_character_id'), table_name='channel_memberships')
    ...
    op.drop_index(op.f('ix_crafting_recipes_result_item_id'), table_name='crafting_recipes')
