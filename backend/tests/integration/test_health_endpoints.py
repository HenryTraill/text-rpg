...
class TestHealthEndpoints:
    ...
    def test_health_endpoint_healthy(self, client):
        ...
        with patch('app.core.health.health_checker.get_health_status', 
                   new_callable=AsyncMock, return_value=mock_health_status):
    ...
    def test_health_endpoint_exception_handling(self, client):
        ...
        with patch('app.core.health.health_checker.get_health_status', 
                   new_callable=AsyncMock, side_effect=Exception("Health check failed")):
    ...
    def test_ready_endpoint_ready(self, client):
        ...
        with patch('app.core.health.health_checker.is_ready', 
    ...
    def test_ready_endpoint_exception_handling(self, client):
        ...
        with patch('app.core.health.health_checker.is_ready', 
                   new_callable=AsyncMock, side_effect=Exception("Readiness check failed")):
    ...
    def test_alive_endpoint_always_responds(self, client):
        ...
        with patch('app.core.health.health_checker.is_alive', 
                   new_callable=AsyncMock, return_value=True):
    ...
    def test_alive_endpoint_exception_handling(self, client):
        ...
        with patch('app.core.health.health_checker.is_alive', 
                   new_callable=AsyncMock, side_effect=Exception("Liveness check failed")):
